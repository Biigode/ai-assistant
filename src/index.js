...
import { getModelsStatus } from './model-router.js';
import { registerBotCommands } from './telegram.js';
...
async function bootstrap() {
  ...
  // Status dos modelos — propriedades: reasoning, chat, local
