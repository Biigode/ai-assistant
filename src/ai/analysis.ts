...
type ResultsInput = SearchResult[] | Record<string, SearchResult[]>;

function buildContext(results: ResultsInput): string {
...
async function analyze(
  ...
  try {
    ...
    console.error("❌ Erro na análise:", (err as Error).message);
    return null;
  }
}
